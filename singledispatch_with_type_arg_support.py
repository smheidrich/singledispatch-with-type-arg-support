...
"""
# As explained in LICENSE, this is just the part of CPython's functools
# responsible for singledispatch, plus some modifications.
# Original CPython functools comments on this module are left intact below but
...
# wraps only included to reduce modifications required for tests
__all__ = ['singledispatch', 'singledispatchmethod', 'wraps']

from abc import get_cache_token
from types import GenericAlias

# no point reproducing these here:
